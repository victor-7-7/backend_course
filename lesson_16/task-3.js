...
print('\n================================\n');
print('Document count in orders collection:', db.orders.stats().count)

print('Orders collection size:', db.orders.stats().size, 'bytes')

print('Customers collection size:', db.customers.stats().size, 'bytes')

print('Data size in DB:', db.stats().dataSize, 'bytes')
